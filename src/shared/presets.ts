...
export const PRESETS: PresetCategory[] = [
  {
    ...
    items: [
      ...
      { name: 'Storm Manhole', objectType: 'block', measurement: 'count', defaultLayer: 'STM-MH', icon: '', accent: 'rose', fields: ['depth', 'diameter'] },
      { name: 'Catch Basin', objectType: 'block', measurement: 'count', defaultLayer: 'STM-CB', icon: '', accent: 'zinc', fields: ['type'] },
    ],
  },
  {
    key: 'paving',
    label: 'Paving',
    items: [
      { name: 'HMA Surface', objectType: 'hatch', measurement: 'area', defaultLayer: 'PV-HMA', icon: '', accent: 'charcoal', fields: ['course', 'thickness'] },
      { name: 'HMA Base', objectType: 'hatch', measurement: 'area', defaultLayer: 'PV-HMA-BASE', icon: '', accent: 'charcoal', fields: ['thickness'] },
      { name: 'Aggregate Base', objectType: 'hatch', measurement: 'area', defaultLayer: 'PV-AGG', icon: '', accent: 'zinc', fields: ['thickness', 'material'] },
      { name: 'Concrete Pavement', objectType: 'closedPolyline', measurement: 'area', defaultLayer: 'PV-CONC', icon: '', accent: 'cloud', fields: ['thickness'] },
      { name: 'Curb & Gutter', objectType: 'polyline', measurement: 'linear', defaultLayer: 'PV-CURB', icon: '', accent: 'cloud', fields: ['type'] },
    ],
  },
  {
    key: 'concrete',
    label: 'Concrete',
    items: [
      { name: 'Sidewalk', objectType: 'closedPolyline', measurement: 'area', defaultLayer: 'SW-CONC', icon: '', accent: 'cloud', fields: ['thickness'] },
      { name: 'Curb Ramp', objectType: 'block', measurement: 'count', defaultLayer: 'SW-RAMP', icon: '', accent: 'cloud', fields: ['type'] },
      { name: 'Driveway', objectType: 'closedPolyline', measurement: 'area', defaultLayer: 'SW-DRWY', icon: '', accent: 'cloud', fields: ['thickness', 'material'] },
    ],
  },
  {
    key: 'site',
    label: 'Site',
    items: [
      { name: 'Custom Linear', objectType: 'polyline', measurement: 'linear', defaultLayer: '', icon: '', accent: 'slate', fields: ['material'], custom: true },
      { name: 'Custom Area', objectType: 'hatch', measurement: 'area', defaultLayer: '', icon: '', accent: 'slate', fields: ['material'], custom: true },
      { name: 'Custom Count', objectType: 'block', measurement: 'count', defaultLayer: '', icon: '', accent: 'slate', fields: ['material'], custom: true },
    ],
  },
];
